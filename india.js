 ...
 let flavorsList = chip.fields.flavors;
    ...
    var filterSpicy = document.querySelector("#spicy");
     ...
     filterTangy.addEventListener("click", function(){
      ...
      if (chipContainer.classList.contains("tangy")) {
        ...
        chipContainer.style.display = "none";
            ...
            var filterCheese = document.querySelector("#cheese");
     filterCheese.addEventListener("click", function(){

      if (chipContainer.classList.contains("cheese")) {
        chipContainer.style.display = "block"; 
      } else {
        chipContainer.style.display = "none";
      }
        ...
        var filterCreamy = document.querySelector("#creamy");
     filterCreamy.addEventListener("click", function(){

      if (chipContainer.classList.contains("creamy")) {
        chipContainer.style.display = "block"; 
      } else {
        chipContainer.style.display = "none";
      }
        ...
        var filterHerb = document.querySelector("#herb");
     filterHerb.addEventListener("click", function(){

      if (chipContainer.classList.contains("herb")) {
        chipContainer.style.display = "block"; 
      } else {
        chipContainer.style.display = "none";
      }
       ...
       var filterSour = document.querySelector("#sour");
     filterSour.addEventListener("click", function(){

      if (chipContainer.classList.contains("sour")) {
        chipContainer.style.display = "block"; 
      } else {
        chipContainer.style.display = "none";
      }
     ...
     filterWavy.addEventListener("click", function(){
      ...
      if (chipContainer.classList.contains("wavy")) {
        chipContainer.style.display = "block"; 
      } else {
        chipContainer.style.display = "none";
      }
